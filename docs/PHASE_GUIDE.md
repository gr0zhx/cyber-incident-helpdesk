...
**Tujuan Dokumen:** Panduan langkah demi langkah untuk membangun sistem secara bertahap menggunakan Claude Code. Setiap fase adalah **checkpoint** yang berdiri sendiri — bisa di-*resume* di sesi Claude Code baru.
...
- `DATABASE_URL` (default: "postgresql://postgres:password@localhost:5432/helpdesk")
...
### Konteks untuk Sesi Claude Code Berikutnya
...
## Tips Penggunaan dengan Claude Code

### Memulai Sesi Baru
Selalu berikan konteks ini di awal sesi Claude Code:
...
### Sebelum Tutup Sesi
Selalu minta Claude Code untuk:
