"""Generate laporan markdown evaluasi RAGAS dataset MITRE ATT&CK."""
import json, re
from datetime import date
from pathlib import Path

results_path = Path("tests/evaluation/rag_ragas_results_mitre.json")
...
dataset_path = Path("tests/evaluation/rag_qa_dataset_mitre.json")
...
lines = []
lines.append("# Laporan Evaluasi RAGAS — Dataset MITRE ATT&CK")
...
report = "\n".join(lines)
out = Path("tests/evaluation/RAGAS_REPORT_MITRE.md")
