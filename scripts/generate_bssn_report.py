"""Generate laporan markdown evaluasi RAGAS dataset BSSN."""
import json, re
from datetime import date
from pathlib import Path

results_path = Path("tests/evaluation/rag_ragas_results_bssn.json")
...
# Merge metadata (incident_type, severity) dari dataset file
dataset_path = Path("tests/evaluation/rag_qa_dataset_bssn.json")
...
lines = []
lines.append("# Laporan Evaluasi RAGAS — Dataset BSSN")
...
lines.append(f"**Pipeline:** Agentic RAG + Hybrid Retrieval (Semantic + BM25) + Reranker\n")
...
# Hitung rata-rata dari ketiga dataset
_all = {}
...
sev_map = {"Tinggi": "🔴 Tinggi", "Sedang": "🟡 Sedang", "Rendah": "🟢 Rendah"}
...
report = "\n".join(lines)
out = Path("tests/evaluation/RAGAS_REPORT_BSSN.md")
